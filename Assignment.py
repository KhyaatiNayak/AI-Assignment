            ...
            for pt in circles [ 0, :]:
                ...
                if r<160 and r>110 and g>104 and g<128 and b>39 and b<45 :
                    if ball_y[-1]==0:
                        ...
                        text = ['\n Timestamp: ', str(time_y[-1]) , " Quadrant: ",str(quad_y[-1]), "Ball Color ", color[0],' Entry \n']
                ...
                if ball_y[-1]==1:
                    if int(timestamp)!=time_y[-1] and int(timestamp)-time_y[-1]>1000:
                        ...
                        ball_y.append(0)
                        time_y.append(int(timestamp))
                        text = ['\n Timestamp: ', str(time_y[-1]) , "Ball Color ", color[0],' Exit \n']
                ...
                if r<230 and r>210 and g>105 and g<130 and b>80 and b<105:
                    if ball_o[-1]==0:
                        ...
                        text = ['\n Timestamp: ', str(time_o[-1]) , " Quadrant: ",str(quad_o[-1]), "Ball Color: ", color[1],' Type: Entry \n']                        
                ...
                if ball_o[-1]==1:
                    if int(timestamp)!=time_o[-1] and int(timestamp)-time_o[-1]>1000:
                        ...
                        ball_o.append(0)
                        time_o.append(int(timestamp))
                        text = ['\n Timestamp: ', str(time_o[-1]) , "Ball Color: ", color[1],' Type: Exit \n']
                ...
                if r<55 and r>30 and g>65 and g<90 and b>66 and b<99:
                    if ball_g[-1]==0:
                        ...
                        text = ['\n Timestamp: ', str(time_g[-1]) , " Quadrant: ",str(quad_g[-1]), "Ball Color: ", color[2],' Type: Entry \n']
                ...
                if ball_g[-1]==1:
                    if int(timestamp)!=time_g[-1] and int(timestamp)-time_g[-1]>1000:
                        ...
                        ball_g.append(0)
                        time_g.append(int(timestamp))
                        text = ['\n Timestamp: ', str(time_g[-1]) , "Ball Color: ", color[2],' Type: Exit \n']
                ...
                if r<190 and r>160 and g>180 and g<190 and b>140 and b<170:
                    if ball_w[-1]==0:
                        ...
                        text = ['\n Timestamp: ', str(time_w[-1]) , " Quadrant: ",str(quad_w[-1]), "Ball Color: ", color[3],' Type: Entry \n']
                ...
                if ball_w[-1]==1:
                    if int(timestamp)!=time_w[-1] and int(timestamp)-time_w[-1]>1000:
                        ...
                        ball_w.append(0)
                        time_w.append(int(timestamp))
                        text = ['\n Timestamp: ', str(time_w[-1]) , "Ball Color: ", color[3],' Type: Exit \n']
